...
file_name1 = 'C:/Users/pratik pc/Desktop/cnnproj/data/training/track1/training_datafull_colourTrue.npy'
input_data = np.load(file_name1)
print(np.shape(input_data))
input_trainingdata = input_data[:7500]
input_testdata = input_data[7500:]
